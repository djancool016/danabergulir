 ...
 <div class="content">  
      <div class="page-title"> 
        <div class="row-fluid">
			<div class="span8">
				<i class="icon-custom-left"></i><h3>Buku - <span class="semi-bold">Bank</span></h3>
			</div>
		</div>
      </div>
        ...
        <div class="grid-title no-border bg-green" style="margin-top : 10px">
				  <div class="row-fluid">
					<table width="100%">
						<tr>
							...
							<td width="20%" nowrap align="right"><h4><span class="semi-bold">Model U-4</span></h4></td>
						</tr>
						<tr>
              ...
              <td width="20%" nowrap align="right"><h4 style="color: #fff;"><span class="semi-bold"><?php echo get_userdata("kota_name"); ?></span></h4></td>
                ...
                <div class="grid-body no-border"> <br>
				  <div align="center">
						<h2><span class="semi-bold">BUKU BANK</span></h2>
...
<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered no-more-tables" id="example4" width="100%" >
  ...
  <tr>
    ...
    <td><?php echo"$b[no]"; ?></td>
    <td style="text-align : right"><?php if($b['type'] == "out"){ echo $base; if(!$b['is_initial']) $saldo += $b[base]; }else echo "-"; ?></td>
    <td style="text-align : right"><?php if($b['type'] == "in"){ echo $base; if(!$b['is_initial']) $saldo -= $b[base]; }else echo "-"; ?></td>
    <td style="text-align : right"><?php echo decimal($saldo); ?></td>
  </tr>
  <?php } ?>
</table>
