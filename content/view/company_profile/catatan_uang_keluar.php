...
<div class="content">  
      <div class="page-title"> <i class="icon-custom-left"></i>
        <div class="row-fluid">
			<div class="span6">
				<h3>Catatan - <span class="semi-bold">Uang Keluar</span></h3>
			</div>
		</div>
      </div>
        ...
        <div class="span12">
          ...
          <table width="100%">
            <tr>
              ...
              <td width="20%" nowrap align="right"><h4 style="color: #fff;"><span class="semi-bold">Model U-2</span></h4></td>
            </tr>
            <tr>
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="table table-striped" id="tabelreport" width="100%" >
                ...
                <?php while ($b = mysql_fetch_array($a)){ ?>
                  <tr>
                    ...
                    <td style="text-align : right" class="center"><?php $total += $b[base]; echo decimal($b[base]); ?></td>
                    ...
                    <td>
                      <span class="label label-info" style="margin : 3px; margin-bottom : 10px">
                        ...
                        <a style="color : #fff" href="<?php echo base_url(); ?>content/controller/report.php?halaman=bukti_kas_keluar&id=<?php echo $b[id]; ?>&print=pdf">PDF</a>
                      </span>
                    </td>
                  </tr>
                <?php } ?>
